...
test('correct task should be deleted from correct array', () => {
  const action = taskThunk.removeTask.fulfilled({taskId: "2", todolistId: "todolistId2"}, 'requestId',
...
test('status of specified task should be changed', () => {
  ...
  const action = taskThunk.updateTask.fulfilled(args, 'requestId', args);
...
//     ]
//   , 'requestId',  [  {id: "1", title: "title 1", order: 0, addedDate: ""},
//       {id: "2", title: "title 2", order: 0, addedDate: ""}])
//
...
test('tasks should be added for todolist', () => {
  const action = taskThunk.fetchTasks.fulfilled(
